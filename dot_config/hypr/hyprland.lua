...
-- MIGRATION NOTE: switch binds ("switch:Lid Switch") use hyprlang's switch
-- key syntax. The Lua bind layer may want a different form — if this fails
-- to register, file as TODO and use the wiki's switch section.
hl.bind("switch:Lid Switch", hl.dsp.exec_cmd(home .. "/.config/hypr/scripts/lid.sh"), { locked = true })
