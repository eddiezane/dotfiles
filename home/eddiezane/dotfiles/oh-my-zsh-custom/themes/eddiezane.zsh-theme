PROMPT='$(kube_ps1) $(nix_check)%{$FG[207]%}$(ssh_check)%2~%{$fg_bold[white]%}$(git_prompt_info)%{$fg_bold[grey]%}%{$fg[yellow]%}$(gs_check)$(gopath_check)%{$reset_color%} '
...
ZSH_THEME_GIT_PROMPT_CLEAN="%{$fg[green]%} ☀️"
